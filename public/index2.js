...
function updateSensorReadings(jsonResponse) {
  ...
  updateBoxes(temperature1, humidity1, temperature2, humidity2);

  updateGauge(temperature1, humidity1, temperature2, humidity2);
...
function updateBoxes(temperature1, humidity1, temperature2, humidity2) {
...
function updateGauge(temperature1, humidity1, temperature2, humidity2) {
...
function fetchMQTTConnection() {
  fetch("/mqttConnDetails", {
    ...
    .then(function (data) {
      initializeMQTTConnection(data.mqttServer, data.mqttTopic2);
    })
